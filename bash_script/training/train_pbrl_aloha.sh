  ...
  for CONFIG_NAME in "${ALL_CONFIGS[@]}"; do
    ...
    for CPL_TYPE in "cplkl"; do # "sft", "cplkl"
      for BIAS_REG in 0.25; do      # 0.25 0.5 0.75 1
        ...
        DATASET_PATH='data/aloha/short_folding_demo/short_folding_demo.hdf5'   # ${task_name} will be replaced during run-time
        DATASET_1="data/aloha/short_folding_rollout/short_folding_rollout.hdf5"
        DATASET_2="data/aloha/short_folding_rollout/short_folding_rollout.hdf5"
        ...
        EXP_NAME="${CPL_TYPE}_pseu_dpT_ExpD${USE_EXP_DATA_1}${USE_EXP_DATA_2}_N${N_QUERIES}_L${SEG_SIZE}_1ER${TRAIN_RATIO}_SFT${SFT_TYPE}${N_EPOCH_SFT}_segM${SEG_MARGIN}_nD${N_DEMOS_FOR_PREF}_beta${CPL_BETA}_clip${CLIP_MARGIN}_unclipwin${UNCLIP_WIN}_smooth${SMOOTH_LABEL}"
