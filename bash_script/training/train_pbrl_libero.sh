  ...
  for CONFIG_NAME in "${ALL_CONFIGS[@]}"; do
    ...
    for CPL_TYPE in "cplkl"; do # "sft", "cplkl"
      for BIAS_REG in 0.25; do      # 0.25 0.5 0.75 1
        ...
        DATASET_1="logs/libero_collect_data_100eps/_"
        DATASET_2="logs/libero_collect_data_100eps/_"
        checkpoint_dir=/pfss/mlde/workspaces/mlde_wsp_MGPATH/VLA/lpb_libero/logs/libero_base_policy/checkpoints/160.pth
        ...
        for SEED in 42; do
          HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=${GPU} python train.py \
            ...
            training.rollout_every=10 training.checkpoint_every=10 \
