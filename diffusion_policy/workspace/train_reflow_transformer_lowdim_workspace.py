...
from diffusion_policy.policy.reflow_transformer_lowdim_policy import ReFlowTransformerLowdimPolicy
...
# %%
class TrainReFlowTransformerLowdimWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: ReFlowTransformerLowdimPolicy
        ...
        self.ema_model: ReFlowTransformerLowdimPolicy = None
    ...
    def run(self):
        ...
        dataset = hydra.utils.instantiate(cfg.task.dataset, mixed_bc=cfg.mixed_bc, filtered_bc=cfg.filtered_bc, rollout_data=cfg.rollout_data)
...
def main(cfg):
    workspace = TrainReFlowTransformerLowdimWorkspace(cfg)
    workspace.run()
