...
from diffusion_policy.policy.cpl_reflow_transformer_lowdim_policy import CplReFlowTransformerLowdimPolicy
...
# %%
class PbrlReFlowTransformerLowdimWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: CplReFlowTransformerLowdimPolicy
        ...
        self.ema_model: CplReFlowTransformerLowdimPolicy = None
...
def main(cfg):
    workspace = PbrlReFlowTransformerLowdimWorkspace(cfg)
    workspace.run()
